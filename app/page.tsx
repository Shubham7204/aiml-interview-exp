...
import { Users, Menu, X, GraduationCap } from "lucide-react"
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-lg sm:text-xl font-bold text-gray-900 truncate">
                  {selectedBatch ? selectedBatch.name : "AIML"} Placement Experiences
                </h1>
          ...
          <div className="space-y-6">
            <div className="text-center mb-6 sm:mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                {selectedBatch ? selectedBatch.name : "AIML"} Interview Experiences
              </h2>
              <p className="text-gray-600 text-sm sm:text-base">
                Browse real interview experiences shared by {selectedBatch ? selectedBatch.name : "AIML"} students
              </p>
            </div>
